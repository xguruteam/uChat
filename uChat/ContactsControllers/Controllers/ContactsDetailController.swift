...
class ContactsDetailController: UITableViewController {
  ...
  let invitationText = "Hey! Download uChat Messenger on the App Store."
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if indexPath.section == 0 {
      ...
      cell.textLabel?.text = "Invite to \(Bundle.main.infoDictionary!["CFBundleDisplayName"] as! String)"
      cell.textLabel?.font = UIFont.systemFont(ofSize: 17)
    }
    return cell
  }
