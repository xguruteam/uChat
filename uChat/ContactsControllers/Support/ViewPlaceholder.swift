...
//  uChat-project
//
//  Created by Luccas Beck on 5/6/19.
...
enum ViewPlaceholderTitle: String {
  case denied = "uChat doesn't have access to your contacts"
  case empty = "You don't have any uChat Users yet."
  case emptyChat = "You don't have any active conversations yet."
}

enum ViewPlaceholderSubtitle: String {
  case denied = "Please go to your iPhone Settings –– Privacy –– Contacts. Then select ON for uChat."
