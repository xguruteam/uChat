...
class UserCell: UITableViewCell {
    ...
    let onlineStatusIndicator: OnlineStatusView = {
...
//      newMessageIndicator.image = UIImage(named: "Oval")
        newMessageIndicator.backgroundColor = UIColor(hexString: "#D1DE0000")
        newMessageIndicator.layer.cornerRadius = 6
  ...
  let badgeLabel: UILabel = {
	...
	override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        onlineStatusIndicator.rightAnchor.constraint(equalTo: profileImageView.rightAnchor).isActive = true
        onlineStatusIndicator.bottomAnchor.constraint(equalTo: profileImageView.bottomAnchor).isActive = true
        onlineStatusIndicator.widthAnchor.constraint(equalToConstant: 20).isActive = true
        onlineStatusIndicator.heightAnchor.constraint(equalToConstant: 20).isActive = true

//        newMessageIndicator.rightAnchor.constraint(equalTo: profileImageView.leftAnchor, constant: -7).isActive = true
        newMessageIndicator.centerXAnchor.constraint(equalTo: badgeLabel.centerXAnchor, constant: 0).isActive = true
